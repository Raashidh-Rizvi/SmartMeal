    ...
    return (
        <div className="recipe-page">
            ...
            <div className="recipe-page-header page-hero page-hero--sub">
                ...
                <UtensilsCrossed size={70} className="hero-sway" style={{ position: 'absolute', opacity: 0.08, color: '#10b981', pointerEvents: 'none', top: '10%', left: '8%', '--rotation': '-15deg', animationDelay: '0s' }} />
                ...
                <BookOpen size={62} className="hero-sway" style={{ position: 'absolute', opacity: 0.08, color: '#10b981', pointerEvents: 'none', top: '60%', right: '5%', '--rotation': '-18deg', animationDelay: '3.1s' }} />
                <Search size={64} className="hero-sway" style={{ position: 'absolute', opacity: 0.05, color: '#10b981', pointerEvents: 'none', bottom: '10%', right: '15%', '--rotation': '-12deg', animationDelay: '1.5s' }} />
                <CookingPot size={70} className="hero-sway" style={{ position: 'absolute', opacity: 0.07, color: '#10b981', pointerEvents: 'none', top: '35%', right: '25%', '--rotation': '30deg', animationDelay: '4.2s' }} />
                <Timer size={52} className="hero-sway" style={{ position: 'absolute', opacity: 0.06, color: '#10b981', pointerEvents: 'none', bottom: '35%', left: '28%', '--rotation': '-25deg', animationDelay: '0.4s' }} />
